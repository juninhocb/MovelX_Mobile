...
class EntregaHomePage extends StatelessWidget {
  const EntregaHomePage({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: const [
            Text("Funcionamento do módulo de entrega",
                style: TextStyle(
            ...
            Text("1. Carregamento", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
            ...
            Text("2. Itinerário", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
