...
class AditivoHomePage extends StatelessWidget {
  const AditivoHomePage({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: const [
            Text("Funcionamento do módulo de aditivos",
                style: TextStyle(
            ...
            Text("1. Agendamento", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
            ...
            Text("2. Correção/Produção", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
