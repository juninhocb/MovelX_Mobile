...
class PosVendaHomePage extends StatelessWidget {
  const PosVendaHomePage({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: const [
            Text("Funcionamento do módulo de pós venda",
                style: TextStyle(
            ...
            Text("1. Feedback Cliente", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
            ...
            Text("2. Nosso Feedback", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainColor, fontSize: 20),),
            SizedBox(
              height: 10,
            ),
            Text(
